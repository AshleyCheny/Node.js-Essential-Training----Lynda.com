...
- Watch changes(.js, .less, .html) (grunt)
- Update bundle files/converted files (grunt)
- restart server (node-dev)
- reload the web page in the browser (node-dev)
